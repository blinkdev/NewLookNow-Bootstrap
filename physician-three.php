...
<head>
    <meta charset="utf-8" />
    <title>Physician Three - New Look Now</title>
...
<body class="full-intro">
    ...
    <div class="wrapper">
        ...
        <!-- physician-three-1 Section -->
        <section id="physician-three-1" class="dark-color hero1 SectionGapWandS1a">
            <div class="container">
                <div class="row text-center" id="physician-three-1-blk1a">
				...
				<form method="post" class="form-bootstrap required" enctype="multipart/form-data" action="_action.php" name="form_physician-three" id="form_physician-three">
                <div class="row" id="physician-three-1-blk2a">
                	<div class="col-md-12 col-sm-12">
                    	...
                    	<div class="col-md-6 col-sm-6 LeftGap1 common-upload-portion1">
                        	<div class="common-upload-portion1-image1 text-center">
                            	<span>
                                    <img src="img/Edited-Portion/single-profile-4.png" alt="image">
                                    <p class="common-p-1">sample</p>
                                </span>
                            ...
                            <div class="common-upload-portion1-button1 text-center">
                            	<span class="btn btn-file">
                                    ...
                                    upload your photo
                                    <!--<div type="file" id="before_photo" name="before_photo"></div>-->
                                    <input type="file" id="before_photo" name="before_photo" class="required"/>									
                                    <input type="hidden" id="dropzone_upload_flag" name="dropzone_upload_flag" value="1"/>
                                    <input type="hidden" id="next_step" name="next_step" value="physician-four.php"/>
                                </span>
                            </div>
                        </div><!-- / col-md-6 -->
                        
                        <div class="col-md-6 col-sm-6 RightGap1">
                        	<p class="common-p-1">Take and upload a photo of your entire head and neck. Use the sample image as your guide.</p>
                            ...
                            <div class="common-empty-box1">
                                <ol class="order-list1">
                                    ...
                                    <li><span>4</span> Pull hair back and away from face</li>
                                </ol>
                            </div>
                        </div><!-- / col-md-6 -->
                    </div><!-- / col-md-12 -->
                ...
                <div class="row" id="physician-three-1-blk3a">
                	<div class="col-md-12 col-sm-12">
                        <nav>
